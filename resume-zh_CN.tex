...
\section{个人总结}
我有扎实的编程基础，熟悉Python和C++，以及能够熟练使用Codex和Claude Code等coding agent，此外我也具备丰富的Linux使用经验，以及一定的OpenClaw使用经验。我对多模态，计算机视觉，具身智能等领域有浓厚兴趣，曾进行过相关课程的自学和多个项目实践，有不错的自学和动手实操能力。我目前的未来规划是出国深造，但是我最终还是希望进入工业界工作
...
\begin{itemize}
  \item 参与 \textbf{Force Policy}（RSS 2026）项目，负责部分实验部署与 baseline 适配工作
...
\textit{RSS 2026} \href{https://arxiv.org/abs/2602.22088}{[Paper]} \href{https://force-policy.github.io/}{[Project]}
